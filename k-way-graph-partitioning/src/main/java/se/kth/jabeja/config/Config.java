...
public class Config {
  ...
  private AnealingPolicy anealingPolicy;
  private Float alpha;
  ...
  public Config setAnealingPolicy(AnealingPolicy anealingPolicy) {
    this.anealingPolicy = anealingPolicy;
    return this;
  }
  ...
  public Config setTrigger(Integer trigger) {
  ...
  public Integer getTrigger() {
    if (trigger == null) {
      throw new NullPointerException("Trigger is not set");
    }
    return trigger;
  }
  ...
  public AnealingPolicy getAnealingPolicy() {
    if (anealingPolicy == null) {
      throw new NullPointerException("Anealing policy is not defined.");
    }
    return anealingPolicy;
  }
