...
public class CLI {
  ...
  @Option(name = "-reset", usage = "Reset round trigger")
  ...
  @Option(name = "-anealingPolicy", usage = "Anealing plicy. Supported, LINEAR, ACPROP")
  private String ANEALING_POLICY = "LINEAR";
  private AnealingPolicy anealingPolicy = AnealingPolicy.LINEAR;
  ...
  public Config parseArgs(String[] args) throws FileNotFoundException {
    ...
    try {
      ...
      if (ANEALING_POLICY.compareToIgnoreCase(AnealingPolicy.LINEAR.toString()) == 0) {
        anealingPolicy = AnealingPolicy.LINEAR;
      } else if (ANEALING_POLICY.compareToIgnoreCase(AnealingPolicy.ACPROP.toString()) == 0) {
        anealingPolicy = AnealingPolicy.ACPROP;
      } else {
        throw new IllegalArgumentException("Anealing policy is not supported");
      }
    ...
    return new Config().setRandNeighborsSampleSize(randNeighborsSampleSize)
            ...
            .setAnealingPolicy(anealingPolicy)
